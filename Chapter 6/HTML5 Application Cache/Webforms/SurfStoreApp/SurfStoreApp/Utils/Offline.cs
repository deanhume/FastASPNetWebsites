...
namespace SurfStoreApp.Utils
{
    public static class Utilities
    {
        ...
        public static string AppendHash(this string fname, RequestContext request)
        {
        ...
        public static Guid GetFileHash(string fname, RequestContext request)
        {
            Guid hash;
            var localPath = request.HttpContext.Server.MapPath(fname.Replace('/', '\\'));
